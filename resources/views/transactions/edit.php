            ...
            <div class="form-content">
                <div class="form-items">
                    ...
                    <form action="/transactions/update" method="POST">
                        ...
                        <div class="col-md-12 ">
                            <input onfocus="this.style.color='#000000'" class="form-control" type="text" placeholder="transaction Title" value="<?= $data->transaction->name_item ?>" disabled>
                        </div>
                        ...
                        <div class="col-md-12 ">
                            ...
                            <div class="form-button mt-3">
                                ...
                                <a href="/selling/page" class="btn btn-danger ms-3 mt-4 mb-2">Cancel</a>
                            </div>
